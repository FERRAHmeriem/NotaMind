        ...
        <div className="control-group">
          <div className="button-group flex gap-4 items-center flex-wrap">
            ...
            <div className=" fixed z-20 bottom-10 right-20 group">
              ...
              {!loading && (
                <span className="absolute -bottom-4 -translate-x-1/2 scale-0 group-hover:scale-100 transition-all bg-purple-400 text-stone-800 text-xs px-2 py-1 rounded shadow whitespace-nowrap">
                  Use AI ✨
                </span>
